...
*   **[data/](https://github.com/aledevv/autotom_digital_twin/tree/main/data)**: Stores the input data, including growth snapshot CSV files and node graph exports (`dynamic_output/graphs/`) generated by the growth simulator.

...
2. **CSV Node Graph Data**: Daily CSV graph exports capturing structural data are written to the folder [model/output/dynamic_output/graphs/](file:///Users/dev/Desktop/agri_robotics/internship/autotom/autotom_digital_twin/model/output/dynamic_output/graphs).
...
The main source code is organized within the [src/plant_model](file:///Users/dev/Desktop/agri_robotics/internship/autotom/autotom_digital_twin/src/plant_model) package:

*   **[main.py](file:///Users/dev/Desktop/agri_robotics/internship/autotom/autotom_digital_twin/src/plant_model/main.py)**: Main entry point. Loads CSV data, runs the USD export pipeline, generates HTML Pyvis debug visualizer files, and exports JSON graph summaries.
*   **[models.py](file:///Users/dev/Desktop/agri_robotics/internship/autotom/autotom_digital_twin/src/plant_model/models.py)**: Defines python dataclasses for individual plant organs (internodes, leaves, fruits, roots) and growth day snapshots.
*   **[loader.py](file:///Users/dev/Desktop/agri_robotics/internship/autotom/autotom_digital_twin/src/plant_model/loader.py)**: Parses daily CSV files and reconstructs the parent-child graph topology.
*   **[usd_exporter.py](file:///Users/dev/Desktop/agri_robotics/internship/autotom/autotom_digital_twin/src/plant_model/usd_exporter.py)**: Main scene building pipeline. Maps components into USD structures, applies materials, and constructs rigid bodies/joints.
*   **[usd_helpers.py](file:///Users/dev/Desktop/agri_robotics/internship/autotom/autotom_digital_twin/src/plant_model/usd_helpers.py)**: Wraps low-level OpenUSD API operations, handling coordinate transforms, cylinder/sphere/mesh creations, material bindings, and physics setups.
*   **[constants.py](file:///Users/dev/Desktop/agri_robotics/internship/autotom/autotom_digital_twin/src/plant_model/constants.py)**: Contains simulation presets, joint limits, stiffness, damping, material colors, and organ dimensions.
*   **[debug_viz.py](file:///Users/dev/Desktop/agri_robotics/internship/autotom/autotom_digital_twin/src/plant_model/debug_viz.py)**: Utility that exports interactive plant structure graphs to HTML using Pyvis.
*   **[graph_export.py](file:///Users/dev/Desktop/agri_robotics/internship/autotom/autotom_digital_twin/src/plant_model/graph_export.py)**: Exports lightweight JSON representations of the plant topology.

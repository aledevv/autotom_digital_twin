"""
run_visual_validation.py - Visual Validation Suite for Joint-Budget Optimization
...
# ---------------------------------------------------------------------------
# Path setup
# This demo is outside pytest collection; import the production optimizer package.
# ---------------------------------------------------------------------------

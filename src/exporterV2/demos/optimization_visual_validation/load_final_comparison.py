"""
load_final_comparison.py - Load Before/After USD Comparison in Isaac Sim
...
Usage:
    ~/isaacsim/python.sh src/exporterV2/demos/optimization_visual_validation/load_final_comparison.py

Or use wrapper:
    ./load_final_comparison.sh
"""
...
def main():
    ...
    if not BASELINE_USD.exists():
        ...
        print("[HINT] Run generate_final_comparison.py first")

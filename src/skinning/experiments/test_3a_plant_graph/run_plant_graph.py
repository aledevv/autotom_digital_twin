"""
run_plant_graph.py — Test 3A-A runtime.
...
import generate_plant_graph as asset
...
def main():
    ...
    print()
    print(
        "  [ ] one coherent plant: main + 3 laterals"
    )
    print(
        "  [ ] all three junctions stay connected"
    )
    print(

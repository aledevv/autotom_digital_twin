"""
generate_plant_graph_3ab.py — Test 3A-B
...
GRAPH_NODES = (
    ...
    PlantBranchNode(
        ...
        tilt_deg=50.0,
        length=0.12,
        curvature_side=0.005,
        curvature_vertical=-0.008,
        physics_links=2,
        base_radius=0.0045,
        tip_radius=0.0025,
        linear_density_kg_per_m=0.10,
    ),
)
...
def build_stage(
    ...
    print("=" * 88)
    print(
        "TEST 3A-B — DATA-DRIVEN PLANT GRAPH"
    )
    print("=" * 88)
    print(
        f"[OK] {output_path}"

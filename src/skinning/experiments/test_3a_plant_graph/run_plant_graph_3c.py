"""
run_plant_graph_3c.py — Test 3C runtime.
...
import generate_plant_graph_3c as asset
...
def main():
    ...
    print()
    print(
        "  [ ] one coherent plant: main + 3 laterals + physical truss"
    )
    print(
        "  [ ] rachis and 3 pedicels remain visibly stiffer than laterals"
    )
    print(
        "  [ ] 3 tomatoes remain attached under gravity"
    )
    print(
        "  [ ] light pulling does not break tomato joints"
    )
    print(
        "  [ ] strong tomato pull breaks only its joint and it falls freely"
    )
    print(
        "  [ ] plant and truss skeletons remain synchronized and stable"
    )
    print()
    print(

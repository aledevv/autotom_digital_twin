...
# C1 = exact Test 2B-C preset C workload,
# except collision resolution is reduced from 2 -> 1 capsule per rigid link.
SYNC_CONFIG = {
    "physics_links": 6,
    "samples_per_control_segment": 12,  # 3*12 + 1 = 37 rings
    "radial_segments": 14,
}

OUTPUT_USD = str(OUTPUT_DIR / "test_2be_double_render.usda")

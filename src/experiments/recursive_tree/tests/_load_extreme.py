...
if physics_scene:
    ...
    physx_scene_api.CreateSolverPositionIterationCountAttr(512)
    physx_scene_api.CreateSolverVelocityIterationCountAttr(64)

    carb.log_info(f"Solver settings: positionIterations={pos_iter}, velocityIterations={vel_iter}")
    print(f"\n================================================================================")
    print(f"SOLVER SETTINGS:")
    print(f"  Position iterations: 512")
    print(f"  Velocity iterations: 64")
    print(f"================================================================================\n")

# Load USD
tree_prim = stage.DefinePrim("/World/tomato", "Xform")
tree_prim.GetReferences().AddReference("/home/alessandro/isaacsim/autotom_digital_twin/src/experiments/recursive_tree/tests/scalability_usds/solver_extreme_pos512_vel64.usda")

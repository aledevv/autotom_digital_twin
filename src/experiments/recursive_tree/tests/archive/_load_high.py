...
if physics_scene:
    ...
    physx_scene_api.CreateSolverPositionIterationCountAttr(256)
    physx_scene_api.CreateSolverVelocityIterationCountAttr(32)

    carb.log_info(f"Solver settings: positionIterations={pos_iter}, velocityIterations={vel_iter}")
    print(f"\n================================================================================")
    print(f"SOLVER SETTINGS:")
    print(f"  Position iterations: 256")
    print(f"  Velocity iterations: 32")
    print(f"================================================================================\n")

# Load USD
tree_prim = stage.DefinePrim("/World/tomato", "Xform")
tree_prim.GetReferences().AddReference("/home/alessandro/isaacsim/autotom_digital_twin/src/experiments/recursive_tree/tests/scalability_usds/solver_high_pos256_vel32.usda")
